...
def newton_interpolation(x, y,png_filename: str = "static/imgs/newton_int_method/newton_int_plot.png", html_filename: str = "static/imgs/newton_int_method/newton_int_plot.html"):
